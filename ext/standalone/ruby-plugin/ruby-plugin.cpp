...
mlirGetDialectPluginInfo() {
  return {MLIR_PLUGIN_API_VERSION, "Ruby", LLVM_VERSION_STRING,
          [](DialectRegistry *registry) {
            registry->insert<mlir::ruby::RubyDialect>();
            mlir::ruby::registerPasses();
          }};
}
...
extern "C" LLVM_ATTRIBUTE_WEAK PassPluginLibraryInfo mlirGetPassPluginInfo() {
  return {MLIR_PLUGIN_API_VERSION, "RubyPasses", LLVM_VERSION_STRING,
          []() { mlir::ruby::registerPasses(); }};
}
